...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Nathamayil Natesh.</h2>;
  const three = <h3 className="big-heading">I love to code and hack.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="https://mayillikestotech.medium.com/"
      target="_blank"
      rel="noreferrer">
      Check out my blog!
    </a>
