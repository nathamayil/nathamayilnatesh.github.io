exports.id = "component---src-pages-pensieve-tags-js";
exports.ids = ["component---src-pages-pensieve-tags-js"];
exports.modules = {
...
/***/ "./src/pages/pensieve/tags.js?export=default":
/*!***************************************************!*\
  !*** ./src/pages/pensieve/tags.js?export=default ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const StyledTagsContainer = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'styled-components'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())`
  max-width: 1000px;
...
const TagsPage = ({
  ...
  location
}) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@components'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
  location: location
  ...
  title: "Tags"
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledTagsContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
  className: "breadcrumb"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
  className: "arrow"
}, "\u2190"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: "/pensieve"
}, "All memories")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Tags"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
  className: "fancy-list"
}, group.map(tag => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
  key: tag.fieldValue
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: `/pensieve/tags/${lodash_kebabCase__WEBPACK_IMPORTED_MODULE_2___default()(tag.fieldValue)}/`,
  className: "inline-link"
}, tag.fieldValue, " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
  className: "count"
}, "(", tag.totalCount, ")")))))));
TagsPage.propTypes = {
  data: prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
    allMarkdownRemark: prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
      group: prop_types__WEBPACK_IMPORTED_MODULE_4___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
        fieldValue: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().string).isRequired,
        totalCount: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number).isRequired
      }).isRequired)
    }),
    site: prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
      siteMetadata: prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
