...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'react-transition-group'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const StyledMainContainer = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'styled-components'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())`
  ${({
  theme
}) => theme.mixins.flexCenter};
  flex-direction: column;
`;
const StyledTitle = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'styled-components'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())`
  color: var(--green);
  font-family: var(--font-mono);
  font-size: clamp(100px, 25vw, 200px);
  line-height: 1;
`;
const StyledSubtitle = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'styled-components'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())`
  font-size: clamp(30px, 5vw, 50px);
  font-weight: 400;
`;
const StyledHomeButton = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'styled-components'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())((0,gatsby__WEBPACK_IMPORTED_MODULE_1__.Link))`
  ${({
  theme
...
const NotFoundPage = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const timeout = setTimeout(() => setIsMounted(true), Object(function webpackMissingModule() { var e = new Error("Cannot find module '@utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
    return () => clearTimeout(timeout);
  }, []);
  const content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledMainContainer, {
  ...
  }), prefersReducedMotion ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, content) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'react-transition-group'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
    component: null
  }, isMounted && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'react-transition-group'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
    timeout: 500,
    classNames: "fadeup"
  }, content)));
};
